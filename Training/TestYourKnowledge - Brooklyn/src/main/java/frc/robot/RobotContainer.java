...
import frc.robot.commands.DriveBackwardsCmd;
...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    new JoystickButton(m_driverController, PS4Controller.Button.kCircle.value).whenHeld(new DriveBackwardsCmd(m_romiDrivetrain));
  }
