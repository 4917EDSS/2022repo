...
void RobotContainer::ConfigureButtonBindings() {
  ...
  climberExtendOpBtn.WhileHeld(ClimberArmRaiseLowerCmd(&m_climberSub, true,&m_operatorController));
  
  frc2::JoystickButton climberRetractOpBtn(&m_operatorController, kClimberRetractOpBtn); // retract climber
  climberRetractOpBtn.WhileHeld(ClimberArmRaiseLowerCmd(&m_climberSub, false, &m_operatorController));
